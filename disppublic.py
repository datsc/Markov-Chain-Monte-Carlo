############################################################################
# Calculates the projected velocity dispersion profile
############################################################################
# Run with python disppublic.py binary.bin disp.dat disp.png 
#####
#TIPSY FILES:
#   header
#   gas
...
filename=sys.argv[1]  #final output of pkdgrav
output=sys.argv[2]    #dispersion in ascii
outfig1=sys.argv[3]   #dispersion figure
...
Theodata=open('obsdispnoisy.dat','r')
...
figure()
title('Projected velocity dispersion profile')
xlabel('r (kpc)')
ylabel(r'$\sigma$ (km/s)')
